    // Global variable for help page to display
	var viewer_aide = '';
	...
	/**
	 * 
	 * @param id_div	Identifiant de la page dans la documentation (appelé lors d'un CTRL+F11)
	 * @return
	 */
	...
	// texte : if you want to put a hard coded message
