<?php
	...
	switch($object_type)
	{
		case '__IFICHE__':
			...
			{
				echo 'sans version XXX('.$_SESSION[$ssid]['objet_fiche']->get_max_version_of_object($object_type,$object_id).') - '.$_SESSION[$ssid]['objet_fiche']->get_title_of_object($object_type,$object_id,$object_version);
			}
			else
			{
				echo 'version XXX'.$object_version.'/'.$_SESSION[$ssid]['objet_fiche']->get_max_version_of_object($object_type,$object_id).' - '.$_SESSION[$ssid]['objet_fiche']->get_title_of_object($object_type,$object_id,$object_version);
			} 
