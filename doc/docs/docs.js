...
MainPanel = function(){
    ...
    MainPanel.superclass.constructor.call(this, {
        ...
        items: {
            id:'welcome-panel',
            title: 'API Home',
            autoLoad: {url: 'accueil.php?ssid='+ssid, callback: this.initSearch, scope: this},
            iconCls:'icon-docs',
            autoScroll: true,
			tbar: [
				'Search: ', ' ',
    ...
    var autoLoad = {url: 'output/Ext.chart.Axis.html'};
...
Ext.onReady(function(){
    ...
    //api.expandPath('/root/apidocs/pkg-Ext/pkg-Ext.chart');			// RBN
   // api.selectPath('/root/apidocs/pkg-Ext/pkg-Ext.chart/Ext.chart.General');
