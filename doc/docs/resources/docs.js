...
Ext.onReady(function(){
    ...
    var hd = new Ext.Panel({
        ...
        new Ext.Toolbar({
			...
			new Ext.form.TextField({
				width: 200,
				emptyText:'Rechercher dans la liste...',
				listeners:{
					render: function(f){
    ...
    page = undefined;	// ++++ RBN ++++ si page n'est pas d�fini � undefined, alors la page plante quand on passe des param�tres.
    if(page){
	...
	function filterTree(e){
		...
		var re = new RegExp(Ext.escapeRe(text), 'i');	// Fait la recherche de l'occurence dans tout le mot complet et non au d�but du mot.
		// MODIF RBN ++END	
