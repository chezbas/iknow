	...
	class postgresql_engine
	{
		...
		public function db_connect()
		{
			 ...
			 * Connect to the vimofy database
			 ====================================================================*/
			//$this->link = pg_connect("host=".$this->c_ident['host']." dbname=vimofy user=".$this->c_ident['user']." password=".$this->c_ident['password']);
			/*$this->link_vimofy = mysql_connect('localhost','vimofy','vimofy');
