...
<html>
	...
	<script  type="text/javascript" src="../ajax/common/ajax_generique_dev.js"></script> <!-- * Include Ajax connexion * -->
	...
	<title><?php echo str_replace('$id',$page,$_SESSION[$ssid]['message'][13]); ?> </title>
	</head>
	<body onload="init_load('<?php echo $_SESSION[$ssid]['langue_TinyMCE'];?>');">
		<form method="post" action="javascript:sauvegarder(ssid,'<?php echo $page;?>');">
			<!-- Gets replaced with TinyMCE, remember HTML in a textarea should be encoded -->
			<div class="description_main">
				<div class="title_caption"><?php echo str_replace('$id',$page,$_SESSION[$ssid]['message'][14]).' : '.$description; ?></div>
				<div class="description_caption"><?php echo $_SESSION[$ssid]['message'][9]?></div>
