<?php 
	...
	//==================================================================
	// Define main query for step varout
	//==================================================================
	$query = "	SELECT (
						CASE `TYPE` 
							WHEN 'OUT' 
							THEN CONCAT('<span class=\"BBVarOut\">',nom,'</span>')
							ELSE CONCAT('<span class=\"BBVarExt\">',nom,'</span>') 
							END
					 ) as Nom,
					 `description`,
					 `TYPE`,
					...
					(
						CASE `TYPE` 
							WHEN 'OUT' 
							THEN CONCAT('<span class=\"BBVarOut\">',`Nom`,'</span>')
							ELSE CONCAT('<span class=\"BBVarExt\">',nom,'(',id_src,'\\\',id_action_src,')','</span>') 
							END
					) as retour,
					`num_version_src`,
					`IDP`,
	...
	$obj_vimofy_varout->define_title($_SESSION[$ssid]['message'][454]);													
	 ...
	 * Define columns
	 ====================================================================*/	
		...
		// Define LOV Columns
		$obj_vimofy_varout->define_column_lov('NOM',$_SESSION[$ssid]['message'][192],__BBCODE__,__WRAP__,__CENTER__);
